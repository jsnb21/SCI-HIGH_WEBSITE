...
Window_Base.prototype.resetFontSettings = function() {
    ...
    this.contents.outlineWidth = 4; // Change this value for thicker/thinner outlines
    this.contents.outlineColor = 'rgba(255, 255, 255, 0.8)'; // Change the color (R, G, B, Alpha)
    this.resetTextColor();
};
...
Window_Base.prototype.hpColor = function(actor) {
    ...
    // Change HP Text Color Base on HP
    if (actor.hp <= actor.mhp * 0.25) { 
        return 'rgba(255, 50, 50, 1)'; // Bright red
    } else if (actor.hp <= actor.mhp * 0.50) {
